...
(function (t, n) {
  ...
  function n(t, n) {
    ...
    function e(e) {
      var h = null == i ? n.ticks ? n.ticks.apply(n, r) : n.domain() : i,
        ...
        c = t === fs || t === ls ? -1 : 1,
        s = t === ls || t === cs ? "x" : "y",
        l = t === fs || t === ss ? w : M;return e.scale = function (t) {
    ...
    var n = k(t);return (n.local ? function (t) {
      ...
      return function () {
        var n = this.ownerDocument,
            e = this.namespaceURI;return e === ps && n.documentElement.namespaceURI === ps ? n.createElement(t) : n.createElementNS(e, t);
      };
    })(n);
    ...
    var u,
      ...
      (f = s[c = ms + a.call(t, o[u], u, o)]) ? (r[u] = f, f.__data__ = o[u], s[c] = null) : e[u] = new U(t, o[u]);
    }for (u = 0; u < l; ++u) {
      (f = n[u]) && s[d[u]] === f && (i[u] = f);
    }
  }function Y(t, n) {
    ...
    var r = xs.hasOwnProperty(t.type) ? nt : et;return function (i, o, a) {
      var u,
          f = this.__on,
    ...
    if (t instanceof It) return new It(t.l, t.a, t.b, t.opacity);if (t instanceof Wt) {
      if (isNaN(t.h)) return new It(t.l, 0, 0, t.opacity);var n = t.h * Us;return new It(t.l, Math.cos(n) * t.c, Math.sin(n) * t.c, t.opacity);
    ...
    if (t instanceof Wt) return new Wt(t.h, t.c, t.l, t.opacity);if (t instanceof It || (t = Bt(t)), 0 === t.a && 0 === t.b) return new Wt(NaN, 0, t.l, t.opacity);var n = Math.atan2(t.b, t.a) * qs;return new Wt(n < 0 ? n + 360 : n, Math.sqrt(t.a * t.a + t.b * t.b), t.l, t.opacity);
  }function $t(t, n, e, r) {
    ...
    return 1 === arguments.length ? function (t) {
      if (t instanceof Qt) return new Qt(t.h, t.s, t.l, t.opacity);t instanceof Lt || (t = zt(t));var n = t.r / 255,
          ...
          f = u ? Math.atan2(a, o) * qs - 120 : NaN;return new Qt(f < 0 ? f + 360 : f, u, i, t.opacity);
    ...
    var e,
        ...
        a = -1,
        u = [],
        f = [];for (t += "", n += ""; (e = al.exec(t)) && (r = ul.exec(n));) {
      (i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, f.push({ i: a, x: sn(e, r) })), o = ul.lastIndex;
    ...
    var e,
        r = typeof n === "undefined" ? "undefined" : _typeof(n);return null == n || "boolean" === r ? nn(n) : ("number" === r ? sn : "string" === r ? (e = kt(n)) ? (n = e, rl) : hn : n instanceof kt ? rl : n instanceof Date ? cn : Array.isArray(n) ? fn : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? ln : sn)(t, n);
  }function pn(t, n) {
    return t = +t, n -= t, function (e) {
      return Math.round(t + n * e);
    };
  }function vn(t, n, e, r, i, o) {
    var a, u, f;return (a = Math.sqrt(t * t + n * n)) && (t /= a, n /= a), (f = t * e + n * r) && (e -= t * f, r -= n * f), (u = Math.sqrt(e * e + r * r)) && (e /= u, r /= u, f /= u), t * r < n * e && (t = -t, n = -n, f = -f, a = -a), { translateX: i, translateY: o, rotate: Math.atan2(n, t) * fl, skewX: Math.atan(f) * fl, scaleX: a, scaleY: u };
  }function gn(t, n, e, r) {
    function i(t) {
    ...
    var e,
        ...
        s = u - i,
        l = f - o,
        h = s * s + l * l;if (h < vl) r = Math.log(c / a) / hl, e = function e(t) {
      ...
      var d = Math.sqrt(h),
          ...
          y = Math.log(Math.sqrt(v * v + 1) - v);r = (y - g) / hl, e = function e(t) {
        var n = t * r,
            e = yn(g),
          ...
          return ((t = Math.exp(t)) - 1 / t) / 2;
        }(g));return [i + u * s, o + u * l, a * e / yn(hl * n + g)];
      };
    ...
    wn(), ++wl;for (var t, n = nl; n;) {
      (t = Sl - n._time) >= 0 && n._call.call(null, t), n = n._next;
    }--wl;
  }function Sn() {
    Sl = (Nl = kl.now()) + El, wl = Ml = 0;try {
      Nn();
    } finally {
      wl = 0, function () {
        var t,
            ...
            e = nl,
            r = 1 / 0;for (; e;) {
          e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : nl = n);
        }el = t, kn(r);
      }(), Sl = 0;
    }
  }function En() {
    var t = kl.now(),
        n = t - Nl;n > Tl && (El -= n, Nl = t);
  }function kn(t) {
    if (!wl) {
      Ml && (Ml = clearTimeout(Ml));t - Sl > 24 ? (t < 1 / 0 && (Ml = setTimeout(Sn, t - kl.now() - El)), Al && (Al = clearInterval(Al))) : (Al || (Nl = kl.now(), Al = setInterval(En, Tl)), wl = 1, Cl(Sn));
    }
  }function Cn(t, n, e) {
    ...
    var a = t.__transition;if (a) {
      ...
      function r(f) {
        var c, s, l, h;if (e.state !== Ll) return o();for (c in u) {
          if ((h = u[c]).name === e.name) {
            if (h.state === Ul) return Cn(r);h.state === ql ? (h.state = Yl, h.timer.stop(), h.on.call("interrupt", t, t.__data__, h.index, h.group), delete u[c]) : +c < n && (h.state = Yl, h.timer.stop(), delete u[c]);
          }
        }if (Cn(function () {
        ...
        e.state = Yl, e.timer.stop(), delete u[n];for (var r in u) {
          return;
    ...
    var e = Ln(t, n);if (e.state > Rl) throw new Error("too late; already scheduled");return e;
  }function Rn(t, n) {
    var e = Ln(t, n);if (e.state > Dl) throw new Error("too late; already started");return e;
  }function Ln(t, n) {
    ...
    var e,
      ...
      n = null == n ? null : n + "";for (i in o) {
        (e = o[i]).name === n ? (r = e.state > Dl && e.state < Ol, e.state = Yl, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : a = !1;
    ...
    var e;return ("number" == typeof n ? sn : n instanceof kt ? rl : (e = kt(n)) ? (n = e, rl) : hn)(t, n);
  }function On(t, n, e, r) {
    ...
    function e(t) {
      var e = t.property("__brush", u).selectAll(".overlay").data([Qn("overlay")]);e.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", mh.overlay).merge(e).each(function () {
        var t = te(this).extent;ct(this).attr("x", t[0][0]).attr("y", t[0][1]).attr("width", t[1][0] - t[0][0]).attr("height", t[1][1] - t[0][1]);
      }), t.selectAll(".selection").data([Qn("selection")]).enter().append("rect").attr("class", "selection").attr("cursor", mh.selection).attr("fill", "#777").attr("fill-opacity", .3).attr("stroke", "#fff").attr("shape-rendering", "crispEdges");var i = t.selectAll(".handle").data(n.handles, function (t) {
        return t.type;
      ...
      function e() {
        ...
        var t;switch (y = U[0] - D[0], _ = U[1] - D[1], A) {case ph:case dh:
            T && (y = Math.max(C - u, Math.min(z - d, y)), c = u + y, p = d + y), N && (_ = Math.max(P - l, Math.min(R - v, _)), h = l + _, g = v + _);break;case vh:
            T < 0 ? (y = Math.max(C - u, Math.min(z - u, y)), c = u + y, p = d) : T > 0 && (y = Math.max(C - d, Math.min(z - d, y)), c = u, p = d + y), N < 0 ? (_ = Math.max(P - l, Math.min(R - l, _)), h = l + _, g = v) : N > 0 && (_ = Math.max(P - v, Math.min(R - v, _)), h = l, g = v + _);break;case gh:
            T && (c = Math.max(C, Math.min(z, u - y * T)), p = Math.max(C, Math.min(z, d + y * T))), N && (h = Math.max(P, Math.min(R, l - _ * N)), g = Math.max(P, Math.min(R, v + _ * N)));}p < c && (T *= -1, t = u, u = d, d = t, t = c, c = p, p = t, M in xh && Y.attr("cursor", mh[M = xh[M]])), g < h && (N *= -1, t = l, l = v, v = t, t = h, h = g, g = t, M in wh && Y.attr("cursor", mh[M = wh[M]])), S.selection && (k = S.selection), m && (c = k[0][0], p = k[1][0]), x && (h = k[0][1], g = k[1][1]), k[0][0] === c && k[0][1] === h && k[1][0] === p && k[1][1] === g || (S.selection = [[c, h], [p, g]], r.call(w), q.brush());
      }function a() {
        ...
        } else bt(t.event.view, b), B.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);O.attr("pointer-events", "all"), Y.attr("cursor", mh.overlay), S.selection && (k = S.selection), ne(k) && (S.selection = null, r.call(w)), q.end();
      }if (t.event.touches) {
        ...
        var u,
            ...
            D = pt(w),
            U = D,
            q = i(w, arguments).beforestart();"overlay" === M ? S.selection = k = [[u = n === _h ? C : D[0], l = n === yh ? P : D[1]], [d = n === _h ? z : u, v = n === yh ? R : l]] : (u = k[0][0], l = k[0][1], d = k[1][0], v = k[1][1]), c = u, h = l, p = d, g = v;var O = ct(w).attr("pointer-events", "none"),
            Y = O.selectAll(".overlay").attr("cursor", mh[M]);if (t.event.touches) O.on("touchmove.brush", e, !0).on("touchend.brush touchcancel.brush", a, !0);else {
          var B = ct(t.event.view).on("keydown.brush", function () {
            switch (t.event.keyCode) {case 16:
                L = T && N;break;case 18:
                A === vh && (T && (d = p - y * T, u = c + y * T), N && (v = g - _ * N, l = h + _ * N), A = gh, o());break;case 32:
                A !== vh && A !== gh || (T < 0 ? d = p - y : T > 0 && (u = c - y), N < 0 ? v = g - _ : N > 0 && (l = h - _), A = ph, Y.attr("cursor", mh.selection), o());break;default:
                return;}Zn();
          }, !0).on("keyup.brush", function () {
            switch (t.event.keyCode) {case 16:
                L && (m = x = L = !1, o());break;case 18:
                A === gh && (T < 0 ? d = p : T > 0 && (u = c), N < 0 ? v = g : N > 0 && (l = h), A = vh, o());break;case 32:
                A === ph && (t.event.altKey ? (T && (d = p - y * T, u = c + y * T), N && (v = g - _ * N, l = h + _ * N), A = gh) : (T < 0 ? d = p : T > 0 && (u = c), N < 0 ? v = g : N > 0 && (l = h), A = vh), Y.attr("cursor", mh[M]), o());break;default:
                return;}Zn();
      ...
      var r = [],
        ...
        function a(t) {
          var n,
            ...
            h,
            d = new Array(),
            p = new Array();u = f = -1, s = t[0] >= n, qh[s << 1].forEach(a);for (; ++u < i - 1;) {
          c = s, s = t[u + 1] >= n, qh[c | s << 1].forEach(a);
        }qh[s << 0].forEach(a);for (; ++f < o - 1;) {
          for (u = -1, s = t[f * i + i] >= n, l = t[f * i] >= n, qh[s << 1 | l << 2].forEach(a); ++u < i - 1;) {
            c = s, s = t[f * i + i + u + 1] >= n, h = l, l = t[f * i + u + 1] >= n, qh[c | s << 1 | l << 2 | h << 3].forEach(a);
          }qh[s | l << 3].forEach(a);
        }u = -1, l = t[f * i] >= n, qh[l << 2].forEach(a);for (; ++u < i - 1;) {
          h = l, l = t[f * i + u + 1] >= n, qh[l << 2 | h << 3].forEach(a);
        }qh[l << 3].forEach(a);
      }(t, n, function (e) {
        f(e, t, n), function (t) {
    ...
    function n(t, n) {
      function e() {
        if (c) return Yh;if (s) return s = !1, Oh;var n,
            e,
            r = u;if (t.charCodeAt(r) === Bh) {
          for (; u++ < a && t.charCodeAt(u) !== Bh || t.charCodeAt(++u) === Bh;) {}return (n = u) >= a ? c = !0 : (e = t.charCodeAt(u++)) === Fh ? s = !0 : e === Ih && (s = !0, t.charCodeAt(u) === Fh && ++u), t.slice(r + 1, n - 1).replace(/""/g, '"');
        }for (; u < a;) {
          if ((e = t.charCodeAt(n = u++)) === Fh) s = !0;else if (e === Ih) s = !0, t.charCodeAt(u) === Fh && ++u;else if (e !== o) continue;return t.slice(r, n);
          ...
          f = 0,
          c = a <= 0,
          s = !1;for (t.charCodeAt(a - 1) === Fh && --a, t.charCodeAt(a - 1) === Ih && --a; (r = e()) !== Yh;) {
        for (var l = []; r !== Oh && r !== Yh;) {
          l.push(r), r = e();
    ...
    if (!(n = ud.exec(t))) throw new Error("invalid format: " + t);var n;this.fill = n[1] || " ", this.align = n[2] || ">", this.sign = n[3] || "-", this.symbol = n[4] || "", this.zero = !!n[5], this.width = n[6] && +n[6], this.comma = !!n[7], this.precision = n[8] && +n[8].slice(1), this.trim = !!n[9], this.type = n[10] || "";
  }function er(t, n) {
    ...
    function n(t) {
      function n(t) {
        var n,
          ...
          }(t)), w && 0 == +t && (w = !1), s = (w ? "(" === c ? c : "-" : "-" === c || "(" === c ? "" : c) + s, x = ("s" === g ? ld[8 + fd / 3] : "") + x + (w && "(" === c ? ")" : ""), m) for (n = -1, r = t.length; ++n < r;) {
    ...
    n = (n *= Qd) / 2 + $d;var e = (t *= Qd) - pd,
        ...
        u = gd * a,
        f = vd * o + u * np(i),
        c = u * r * ap(i);hp.add(tp(c, f)), pd = t, vd = o, gd = a;
  }function Ar(t) {
    ...
    var n = fp(t[0] * t[0] + t[1] * t[1] + t[2] * t[2]);t[0] /= n, t[1] /= n, t[2] /= n;
  }function Pr(t, n) {
    Td.push(Nd = [yd = t, bd = t]), n < _d && (_d = n), n > md && (md = n);
  }function zr(t, n) {
    var e = Tr([t * Qd, n * Qd]);if (Ad) {
      var r = Sr(Ad, e),
          i = Sr([r[1], -r[0], 0], r);Cr(i), i = Ar(i);var o,
          a = t - xd,
          u = a > 0 ? 1 : -1,
          f = i[0] * Zd * u,
          c = Jd(a) > 180;c ^ (u * xd < f && f < u * t) ? (o = i[1] * Zd) > md && (md = o) : (f = (f + 360) % 360 - 180, c ^ (u * xd < f && f < u * t) ? (o = -i[1] * Zd) < _d && (_d = o) : (n < _d && (_d = n), n > md && (md = n))), c ? t < xd ? Or(yd, t) > Or(yd, bd) && (bd = t) : Or(t, bd) > Or(yd, bd) && (yd = t) : bd >= yd ? (t < yd && (yd = t), t > bd && (bd = t)) : t > xd ? Or(yd, t) > Or(yd, bd) && (bd = t) : Or(t, bd) > Or(yd, bd) && (yd = t);
    } else Td.push(Nd = [yd = t, bd = t]);n < _d && (_d = n), n > md && (md = n), Ad = e, xd = t;
  }function Rr() {
    gp.point = zr;
  }function Lr() {
    ...
    if (Ad) {
      var e = t - xd;vp.add(Jd(e) > 180 ? e + (e > 0 ? 360 : -360) : e);
    } else wd = t, Md = n;pp.point(t, n), zr(t, n);
  }function Ur() {
    pp.lineStart();
  }function qr() {
    ...
    t *= Qd;var e = np(n *= Qd);Ir(e * np(t), e * ap(t), ap(n));
  }function Ir(t, n, e) {
    kd += (t - kd) / ++Sd, Cd += (n - Cd) / Sd, Pd += (e - Pd) / Sd;
  }function jr() {
    yp.point = Hr;
  }function Hr(t, n) {
    t *= Qd;var e = np(n *= Qd);Bd = e * np(t), Fd = e * ap(t), Id = ap(n), yp.point = Xr, Ir(Bd, Fd, Id);
  }function Xr(t, n) {
    t *= Qd;var e = np(n *= Qd),
        r = e * np(t),
        i = e * ap(t),
        o = ap(n),
        a = tp(fp((a = Fd * o - Id * i) * a + (a = Id * r - Bd * o) * a + (a = Bd * i - Fd * r) * a), Bd * r + Fd * i + Id * o);Ed += a, zd += a * (Bd + (Bd = r)), Rd += a * (Fd + (Fd = i)), Ld += a * (Id + (Id = o)), Ir(Bd, Fd, Id);
  }function Gr() {
    yp.point = Fr;
  }function Vr() {
    yp.point = Wr;
    ...
    Od = t, Yd = n, t *= Qd, n *= Qd, yp.point = Zr;var e = np(n);Bd = e * np(t), Fd = e * ap(t), Id = ap(n), Ir(Bd, Fd, Id);
  }function Zr(t, n) {
    t *= Qd;var e = np(n *= Qd),
        r = e * np(t),
        i = e * ap(t),
        ...
        c = fp(a * a + u * u + f * f),
        s = dr(c),
        l = c && -s / c;Dd += l * a, Ud += l * u, qd += l * f, Ed += s, zd += s * (Bd + (Bd = r)), Rd += s * (Fd + (Fd = i)), Ld += s * (Id + (Id = o)), Ir(Bd, Fd, Id);
  }function Qr(t) {
    return function () {
      return t;
    };
    ...
    function e(t, n) {
      var e = np(n),
          ...
          f = ap(t) * e,
          c = ap(n),
          s = c * r + u * i;return [tp(f * o - s * a, u * r - c * i), dr(s * o + f * a)];
    }var r = np(t),
        i = ap(t),
        o = np(n),
        a = ap(n);return e.invert = function (t, n) {
      var e = np(n),
          u = np(t) * e,
          f = ap(t) * e,
          c = ap(n),
          s = c * o - f * a;return [tp(f * o + c * a, u * r + s * i), dr(s * r - u * i)];
    }, e;
  }function ii(t) {
    function n(n) {
    ...
    if (e) {
      var a = np(n),
          u = ap(n),
          f = r * e;null == i ? (i = n + r * Wd, o = n - f / 2) : (i = ai(a, i), o = ai(a, o), (r > 0 ? i < o : i > o) && (i += r * Wd));for (var c, s = i; r > 0 ? s > o : s < o; s -= f) {
    ...
    var e = n[0],
        ...
        o = [ap(e), -np(e), 0],
        a = 0,
        u = 0;kp.reset(), 1 === i ? r = Vd + Hd : -1 === i && (r = -Vd - Hd);for (var f = 0, c = t.length; f < c; ++f) {
      if (l = (s = t[f]).length) for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + $d, v = ap(p), g = np(p), y = 0; y < l; ++y, d = b, v = x, g = w, h = _) {
        var _ = s[y],
            b = _[0],
            m = _[1] / 2 + $d,
            x = ap(m),
            ...
            T = A * M,
            N = T > Gd,
            S = v * x;if (kp.add(tp(S * A * ap(T), g * w + S * np(T))), a += N ? M + A * Wd : M, N ^ d >= e ^ b >= e) {
    ...
    function n(t, n) {
      ...
      var r = [1, 0, 0],
        ...
        var y = fp(g),
            ...
            T = Jd(A - Gd) < Hd;if (!T && M < w && (b = w, w = M, M = b), T || A < Hd ? T ? w + M > 0 ^ _[1] < (Jd(_[0] - m) < Hd ? w : M) : w <= _[1] && _[1] <= M : A > Gd ^ (m <= _[0] && _[0] <= x)) {
      ...
      var r = a ? t : Gd - t,
        ...
        o = 6 * Qd,
        a = i > 0,
        u = Jd(i) > Hd;return di(n, function (t) {
      var i, o, f, c, s;return { lineStart: function lineStart() {
          ...
          var d,
              p = [l, h],
              v = n(l, h),
              g = a ? v ? 0 : r(l, h) : v ? r(l + (l < 0 ? Gd : -Gd), h) : 0;if (!i && (c = f = v) && t.lineStart(), v !== f && (!(d = e(i, p)) || fi(i, d) || fi(p, d)) && (p[0] += Hd, p[1] += Hd, v = n(p[0], p[1])), v !== f) s = 0, v ? (t.lineStart(), d = e(p, i), t.point(d[0], d[1])) : (d = e(i, p), t.point(d[0], d[1]), t.lineEnd()), i = d;else if (u && i && a ^ v) {
      ...
      function f(t, n) {
        ...
        var u = i(o, a);if (l && h.push([o, a]), m) d = o, p = a, v = u, m = !1, u && (w.lineStart(), w.point(o, a));else if (u && b) w.point(o, a);else {
          var f = [g = Math.max(zp, Math.min(Pp, g)), _ = Math.max(zp, Math.min(Pp, _))],
              c = [o = Math.max(zp, Math.min(Pp, o)), a = Math.max(zp, Math.min(Pp, a))];!function (t, n, e, r, i, o) {
            var a,
                u = t[0],
                f = t[1],
                c = 0,
    ...
    t *= Qd;var e = ap(n *= Qd),
        ...
        a = r * ap(i),
        u = mp * e - bp * r * o,
        f = bp * e + mp * r * o;Rp.add(tp(fp(a * a + u * u), f)), _p = t, bp = e, mp = r;
  }function xi(t) {
    ...
    var e = wi(t[0], t[1]);return wi(t[0], n) + wi(n, t[1]) <= e + Hd;
  }function Ni(t, n) {
    ...
    var r = s(t, n - Hd, e).concat(n);return function (t) {
    ...
    var e = t - Sp,
        r = n - Ep,
        i = fp(e * e + r * r);Zp += i * (Sp + t) / 2, Qp += i * (Ep + n) / 2, Jp += i, qi(Sp = t, Ep = n);
  }function Fi() {
    ev.point = qi;
  }function Ii() {
    ev.point = Hi;
    ...
    var e = t - Sp,
        r = n - Ep,
        i = fp(e * e + r * r);Zp += i * (Sp + t) / 2, Qp += i * (Ep + n) / 2, Jp += i, Kp += (i = Ep * t - Sp * n) * (Sp + t), tv += i * (Ep + n), nv += 3 * i, qi(Sp = t, Ep = n);
  }function Gi(t) {
    this._context = t;
  }function Vi(t, n) {
    ...
    var r = t.clipExtent && t.clipExtent();return t.scale(150).translate([0, 0]), null != r && t.clipExtent(null), br(e, t.stream(Gp)), n(Gp.result()), null != r && t.clipExtent(r), t;
  }function to(t, n, e) {
      ...
      function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
        var y = c - r,
          ...
          var m = a + h,
              ...
              k = S - r,
              C = E - i,
              P = _ * k - y * C;(P * P / b > n || Jd((y * k + _ * C) / b - .5) > .3 || a * h + u * d + f * p < lv) && (e(r, i, o, a, u, f, S, E, T, m /= M, x /= M, w, v, g), g.point(S, E), e(S, E, T, m, x, w, c, s, l, h, d, p, v, g));
        }
      }return function (n) {
        function r(e, r) {
          ...
          var o = Tr([r, i]),
              a = t(r, i);e(y, _, g, b, m, x, y = a[0], _ = a[1], g = r, b = o[0], m = o[1], x = o[2], sv, n), n.point(y, _);
        }function a() {
          w.point = r, n.lineEnd();
        }function u() {
    ...
    function e(t, n) {
      var e = fp(o - 2 * i * ap(n)) / i;return [e * ap(t *= i), a - e * np(t)];
    }var r = ap(t),
        i = (r + ap(n)) / 2;if (Jd(i) < Hd) return function (t) {
      function n(t, n) {
        return [t * e, ap(n) / e];
      }var e = np(t);return n.invert = function (t, n) {
        return [t / e, dr(n * e)];
      }, n;
    }(t);var o = 1 + r * (2 * i - r),
        a = fp(o) / i;return e.invert = function (t, n) {
      var e = a - n;return [tp(t, Jd(e)) / i * up(e), dr((o - (t * t + e * e) * i * i) / (2 * i))];
    }, e;
  }function so() {
    ...
    function e(t, n) {
      o > 0 ? n < -Vd + Hd && (n = -Vd + Hd) : n > Vd - Hd && (n = Vd - Hd);var e = o / op(yo(n), i);return [e * ap(i * t), o - e * np(i * t)];
    }var r = np(t),
        i = t === n ? ap(t) : ip(r / np(n)) / ip(yo(n) / yo(t)),
        o = r * op(yo(t), i) / i;return i ? (e.invert = function (t, n) {
      var e = o - n,
          r = up(i) * fp(t * t + e * e);return [tp(t, Jd(e)) / i * up(e), 2 * Kd(op(o / r, 1 / i)) - Vd];
    }, e) : vo;
  }function bo(t, n) {
    return [t, n];
  }function mo(t, n) {
    function e(t, n) {
      var e = o - n,
          r = i * t;return [e * ap(r), o - e * np(r)];
    }var r = np(t),
        i = t === n ? ap(t) : (r - np(n)) / (n - t),
        o = r / i + t;return Jd(i) < Hd ? bo : (e.invert = function (t, n) {
      var e = o - n;return [tp(t, Jd(e)) / i * up(e), o - up(i) * fp(t * t + e * e)];
    }, e);
  }function xo(t, n) {
    var e = np(n),
    ...
    function n(n) {
      var o = n + "",
          a = e.get(o);if (!a) {
        if (i !== Pv) return i;e.set(o, a = r.push(n));
      }return t[(a - 1) % t.length];
    }var e = he(),
        r = [],
        i = Pv;return t = null == t ? [] : Cv.call(t), n.domain = function (t) {
    ...
    var i = Math.min(t.length, n.length) - 1,
      ...
      var e = Kc(t, n, 1, i) - 1;return a[e](o[e](n));
    };
  }function Aa(t, n) {
    ...
    function n(t, n) {
      return function (e) {
        var r,
          ...
          37 === t.charCodeAt(u) && (a.push(t.slice(f, u)), null != (i = Ug[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), a.push(r), f = u + 1);
      ...
      return function (e) {
        var i,
          ...
          if (a.V < 1 || a.V > 53) return null;"w" in a || (a.w = 1), "Z" in a ? (i = (o = (i = Ga(Va(a.y))).getUTCDay()) > 4 || 0 === o ? _g.ceil(i) : _g(i), i = vg.offset(i, 7 * (a.V - 1)), a.y = i.getUTCFullYear(), a.m = i.getUTCMonth(), a.d = i.getUTCDate() + (a.w + 6) % 7) : (i = (o = (i = n(Va(a.y))).getDay()) > 4 || 0 === o ? $v.ceil(i) : $v(i), i = Xv.offset(i, 7 * (a.V - 1)), a.y = i.getFullYear(), a.m = i.getMonth(), a.d = i.getDate() + (a.w + 6) % 7);
    ...
    var r = qg.exec(n.slice(e, e + 1));return r ? (t.w = +r[0], e + r[0].length) : -1;
  }function tu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 1));return r ? (t.u = +r[0], e + r[0].length) : -1;
  }function nu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.U = +r[0], e + r[0].length) : -1;
  }function eu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.V = +r[0], e + r[0].length) : -1;
  }function ru(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.W = +r[0], e + r[0].length) : -1;
  }function iu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 4));return r ? (t.y = +r[0], e + r[0].length) : -1;
  }function ou(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.y = +r[0] + (+r[0] > 68 ? 1900 : 2e3), e + r[0].length) : -1;
  }function au(t, n, e) {
    var r = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(n.slice(e, e + 6));return r ? (t.Z = r[1] ? 0 : -(r[2] + (r[3] || "00")), e + r[0].length) : -1;
  }function uu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.m = r[0] - 1, e + r[0].length) : -1;
  }function fu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.d = +r[0], e + r[0].length) : -1;
  }function cu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 3));return r ? (t.m = 0, t.d = +r[0], e + r[0].length) : -1;
  }function su(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.H = +r[0], e + r[0].length) : -1;
  }function lu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.M = +r[0], e + r[0].length) : -1;
  }function hu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 2));return r ? (t.S = +r[0], e + r[0].length) : -1;
  }function du(t, n, e) {
    var r = qg.exec(n.slice(e, e + 3));return r ? (t.L = +r[0], e + r[0].length) : -1;
  }function pu(t, n, e) {
    var r = qg.exec(n.slice(e, e + 6));return r ? (t.L = Math.floor(r[0] / 1e3), e + r[0].length) : -1;
  }function vu(t, n, e) {
    var r = Og.exec(n.slice(e, e + 1));return r ? e + r[0].length : -1;
  }function gu(t, n, e) {
    var r = qg.exec(n.slice(e));return r ? (t.Q = +r[0], e + r[0].length) : -1;
  }function yu(t, n, e) {
    var r = qg.exec(n.slice(e));return r ? (t.Q = 1e3 * +r[0], e + r[0].length) : -1;
  }function _u(t, n) {
    ...
    var e = t.getDay();return t = e >= 4 || 0 === e ? Qv(t) : Qv.ceil(t), Wa(Qv.count(cg(t), t) + (4 === cg(t).getDay()), n, 2);
  }function Cu(t) {
    return t.getDay();
  }function Pu(t, n) {
    ...
    var e = t.getUTCDay();return t = e >= 4 || 0 === e ? xg(t) : xg.ceil(t), Wa(xg.count(Rg(t), t) + (4 === Rg(t).getUTCDay()), n, 2);
  }function Vu(t) {
    return t.getUTCDay();
  }function $u(t, n) {
    ...
    function s(e) {
      ...
      if (null == n && (n = 10), "number" == typeof n) {
        var a = Math.abs(i - r) / n,
            u = e(function (t) {
          return t[2];
        }).right(A, a);u === A.length ? (o = d(r / Wg, i / Wg, n), n = t) : u ? (o = (u = A[a / A[u - 1][2] < A[u][2] / a ? u - 1 : u])[1], n = u[0]) : (o = Math.max(d(r, i, n), 1), n = f);
        ...
        w = c("%B"),
        M = c("%Y"),
        A = [[u, 1, jg], [u, 5, 5 * jg], [u, 15, 15 * jg], [u, 30, 30 * jg], [a, 1, Hg], [a, 5, 5 * Hg], [a, 15, 15 * Hg], [a, 30, 30 * Hg], [o, 1, Xg], [o, 3, 3 * Xg], [o, 6, 6 * Xg], [o, 12, 12 * Xg], [i, 1, Gg], [i, 2, 2 * Gg], [r, 1, Vg], [n, 1, $g], [n, 3, 3 * $g], [t, 1, Wg]];return h.invert = function (t) {
      return new Date(p(t));
    }, h.domain = function (t) {
    ...
    function n(n) {
      var r = (n - e) * i;return t(o ? Math.max(0, Math.min(1, r)) : r);
    }var e = 0,
        r = 1,
        i = 1,
        o = !1;return n.domain = function (t) {
    ...
    function n(n) {
      var e = .5 + ((n = +n) - r) * (n < r ? o : a);return t(u ? Math.max(0, Math.min(1, e)) : e);
    }var e = 0,
        r = .5,
        i = 1,
        o = 1,
        a = 1,
        u = !1;return n.domain = function (t) {
    ...
    var o = zf(n, e),
        a = zf(n, e = (e + i) / 2),
        u = zf(r, e),
        f = zf(r, i);t.moveTo(o[0], o[1]), t.bezierCurveTo(a[0], a[1], u[0], u[1], f[0], f[1]);
  }function Yf() {}function Bf(t, n, e) {
    ...
    var n = t.map(pc);return lc(t).sort(function (t, e) {
      return n[t] - n[e];
    });
  }function pc(t) {
    ...
    var n = t.circle;n && (n.P || (K_ = n.N), eb.remove(n), ib.push(n), bc(n), t.circle = null);
  }function Rc(t) {
    ...
    var n = t.circle,
        ...
        o = t.P,
        a = t.N,
        u = [t];Lc(t);for (var f = o; f.circle && Math.abs(e - f.circle.x) < ab && Math.abs(r - f.circle.cy) < ab;) {
      o = f.P, u.unshift(f), Lc(f), f = o;
    }u.unshift(f), zc(f);for (var c = a; c.circle && Math.abs(e - c.circle.x) < ab && Math.abs(r - c.circle.cy) < ab;) {
    ...
    for (var n, e, r, i, o = t[0], a = t[1], u = tb._; u;) {
      if ((r = qc(u, a) - o) > ab) u = u.L;else {
        if (!((i = o - function (t, n) {
          var e = t.N;if (e) return qc(e, n);var r = t.site;return r[1] === n ? r[0] : 1 / 0;
        }(u, a)) > ab)) {
          r > -ab ? (n = u.P, e = u) : i > -ab ? (n = u, e = u.N) : n = e = u;break;
        }if (!u.R) {
          n = u;break;
        }u = u.R;
      }
    ...
    })(t);var f = Rc(t);if (tb.insert(n, f), n || e) {
      if (n === e) return zc(n), e = Rc(n.site), tb.insert(f, e), f.edge = e.edge = Mc(n.site, f.site), Pc(n), void Pc(e);if (e) {
        zc(n), zc(e);var c = n.site,
            s = c[0],
            l = c[1],
            h = t[0] - s,
            d = t[1] - l,
            ...
            _ = h * h + d * d,
            b = v * v + g * g,
            m = [(g * _ - d * b) / y + s, (h * b - v * _) / y + l];Tc(e.edge, c, p, m), f.edge = Mc(c, t, null, m), e.edge = Mc(t, p, null, m), Pc(n), Pc(e);
    ...
    var e,
        r,
        i,
        o = t.sort(Yc).pop();for (rb = [], nb = new Array(t.length), tb = new _c(), eb = new _c();;) {
      if (i = K_, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x)) o[0] === e && o[1] === r || (Uc(o), e = o[0], r = o[1]), o = t.pop();else {
        if (!i) break;Dc(i.arc);
      }
    }if (function () {
        ...
        var i,
          ...
          if (o = nb[i]) {
            for (a = o.site, u = (f = o.halfedges).length; u--;) {
              ...
              p = (d = Cc(o, rb[f[u]]))[0], v = d[1], l = (s = kc(o, rb[f[++u % c]]))[0], h = s[1], (Math.abs(p - l) > ab || Math.abs(v - h) > ab) && (f.splice(u, 0, rb.push(Ac(a, d, Math.abs(p - t) < ab && r - v > ab ? [t, Math.abs(l - t) < ab ? h : r] : Math.abs(v - r) < ab && e - p > ab ? [Math.abs(h - r) < ab ? l : e, r] : Math.abs(p - e) < ab && v - n > ab ? [e, Math.abs(l - e) < ab ? h : n] : Math.abs(v - n) < ab && p - t > ab ? [Math.abs(h - n) < ab ? l : t, n] : null)) - 1), ++c);
            }c && (y = !1);
          }
        }if (y) {
          var _,
            ...
            var w = [t, n],
                M = [t, r],
                A = [e, r],
                T = [e, n];y.halfedges.push(rb.push(Ac(a = y.site, w, M)) - 1, rb.push(Ac(a, M, A)) - 1, rb.push(Ac(a, A, T)) - 1, rb.push(Ac(a, T, w)) - 1);
          }
        }for (i = 0; i < g; ++i) {
    ...
    var r = t.invertX(n[0][0]) - e[0][0],
      ...
      ls = 4,
      hs = 1e-6,
      ds = { value: function value() {} };S.prototype = N.prototype = { constructor: S, on: function on(t, n) {
      var e,
          r = this._,
          i = function (t, n) {
    ...
    var ys = document.documentElement;if (!ys.matches) {
      var _s = ys.webkitMatchesSelector || ys.msMatchesSelector || ys.mozMatchesSelector || ys.oMatchesSelector;gs = function gs(t) {
        return function () {
          return _s.call(this, t);
        };
      };
    }
  }var bs = gs;U.prototype = { constructor: U, appendChild: function appendChild(t) {
    ...
    } };var ms = "$";H.prototype = { add: function add(t) {
    ...
    } };var xs = {};if (t.event = null, "undefined" != typeof document) {
    "onmouseenter" in document.documentElement || (xs = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }var ws = [null];ut.prototype = ft.prototype = { constructor: ut, select: function select(t) {
      ...
      "function" != typeof t && (t = bs(t));for (var n = this._groups, e = n.length, r = new Array(e), i = 0; i < e; ++i) {
    ...
    var t = this._.on.apply(this._, arguments);return t === this._ ? this : t;
      ...
      Is = 6 / 29,
      js = 3 * Is * Is,
      Hs = Is * Is * Is;Nt(It, Ft, St(Et, { brighter: function brighter(t) {
      ...
      var t = (this.l + 16) / 116,
          ...
          e = isNaN(this.b) ? t : t - this.b / 200;return n = Os * Ht(n), t = Ys * Ht(t), e = Bs * Ht(e), new Lt(Xt(3.1338561 * n - 1.6168667 * t - .4906146 * e), Xt(-.9787684 * n + 1.9161415 * t + .033454 * e), Xt(.0719453 * n - .2289914 * t + 1.4052427 * e), this.opacity);
      ...
      $s = Vs * Gs,
      Ws = 1.78277 * Vs,
      Zs = 1.78277 * Xs - -.14861 * Gs;Nt(Qt, Zt, St(Et, { brighter: function brighter(t) {
      ...
      var t = isNaN(this.h) ? 0 : (this.h + 120) * Us,
          ...
          r = Math.cos(t),
          i = Math.sin(t);return new Lt(255 * (n + e * (-.14861 * r + 1.78277 * i)), 255 * (n + e * (Xs * r + Gs * i)), 255 * (n + e * (Vs * r)), this.opacity);
    } }));var Qs,
      Js,
      Ks,
      tl,
    ...
    return null == t ? cl : (tl || (tl = document.createElementNS("http://www.w3.org/2000/svg", "g")), tl.setAttribute("transform", t), (t = tl.transform.baseVal.consolidate()) ? (t = t.matrix, vn(t.a, t.b, t.c, t.d, t.e, t.f)) : cl);
      ...
      Sl = 0,
      El = 0,
      kl = "object" == (typeof performance === "undefined" ? "undefined" : _typeof(performance)) && performance.now ? performance : Date,
      Cl = "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function (t) {
    setTimeout(t, 17);
  };An.prototype = Tn.prototype = { constructor: An, restart: function restart(t, n, e) {
      if ("function" != typeof t) throw new TypeError("callback is not a function");e = (null == e ? wn() : +e) + (null == n ? 0 : +n), this._next || el === this || (el ? el._next = this : nl = this, el = this), this._call = t, this._time = e, kn();
    }, stop: function stop() {
      ...
      Fl = 0,
      Il = ft.prototype;On.prototype = Yn.prototype = { constructor: On, select: function select(t) {
      var n = this._name,
    ...
    }, call: Il.call, nodes: Il.nodes, node: Il.node, size: Il.size, empty: Il.empty, each: Il.each, on: function on(t, n) {
      ...
      var e = k(t),
          r = "transform" === e ? ll : qn;return this.attrTween(t, "function" == typeof n ? (e.local ? function (t, n, e) {
      ...
      var r = "transform" == (t += "") ? sl : qn;return null == n ? this.styleTween(t, function (t, n) {
    ...
    }var i = Math.asin(1 / (n = Math.max(1, n))) * (e /= uh);return r.amplitude = function (n) {
      return t(n, e * uh);
    }, r.period = function (e) {
      return t(n, e);
    }, r;
    ...
    function r(t) {
      ...
      lh = { time: null, delay: 0, duration: 250, ease: In };ft.prototype.interrupt = function (t) {
    return this.each(function () {
      Dn(this, t);
    });
  }, ft.prototype.transition = function (t) {
    var n, e;t instanceof On ? (n = t._id, t = t._name) : (n = Bn(), (e = lh).time = wn(), t = null == t ? null : t + "");for (var r = this._groups, i = r.length, o = 0; o < i; ++o) {
      for (var a, u = r[o], f = u.length, c = 0; c < f; ++c) {
      ...
      vh = { name: "handle" },
      gh = { name: "center" },
      yh = { name: "x", handles: ["e", "w"].map(Qn), input: function input(t, n) {
      return t && [[t[0], n[0][1]], [t[1], n[1][1]]];
    }, output: function output(t) {
      return t && [t[0][0], t[1][0]];
    } },
      _h = { name: "y", handles: ["n", "s"].map(Qn), input: function input(t, n) {
      return t && [[n[0][0], t[0]], [n[1][0], t[1]]];
    }, output: function output(t) {
      return t && [t[0][1], t[1][1]];
    } },
      bh = { name: "xy", handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(Qn), input: function input(t) {
      return t;
    }, output: function output(t) {
      return t;
    } },
      ...
      zh = Math.PI,
      Rh = 2 * zh,
      Lh = Rh - 1e-6;ie.prototype = oe.prototype = { constructor: ie, moveTo: function moveTo(t, n) {
    ...
    } };var Dh = he.prototype;ye.prototype = _e.prototype = { constructor: ye, has: Dh.has, add: function add(t) {
      return t += "", this["$" + t] = t, this;
    }, remove: Dh.remove, clear: Dh.clear, values: Dh.keys, size: Dh.size, empty: Dh.empty, each: Dh.each };var Uh = Array.prototype.slice,
      ...
      ed = Ue("text/html"),
      rd = Ue("image/svg+xml"),
      id = je.prototype = He.prototype;id.copy = function () {
    var t,
        n,
    ...
    return arguments.length ? (this._y = t, this) : this._y;
      ...
      ud = /^(?:(.)?([<>=^]))?([+\-\( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;tr.prototype = nr.prototype, nr.prototype.toString = function () {
    return this.fill + this.align + this.sign + this.symbol + (this.zero ? "0" : "") + (null == this.width ? "" : Math.max(1, 0 | this.width)) + (this.comma ? "," : "") + (null == this.precision ? "" : "." + Math.max(0, 0 | this.precision)) + (this.trim ? "~" : "") + this.type;
      ...
      ld = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];or({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }), sr.prototype = { constructor: sr, reset: function reset() {
      this.s = this.t = 0;
    }, add: function add(t) {
    ...
    return t > 0 ? 1 : t < 0 ? -1 : 0;
      ...
      fp = Math.sqrt,
      cp = Math.tan,
      sp = { Feature: function Feature(t, n) {
      gr(t.geometry, n);
      ...
      hp = cr(),
      dp = cr(),
      pp = { point: vr, lineStart: vr, lineEnd: vr, polygonStart: function polygonStart() {
      hp.reset(), pp.lineStart = mr, pp.lineEnd = xr;
    }, polygonEnd: function polygonEnd() {
      var t = +hp;dp.add(t < 0 ? Wd + t : t), this.lineStart = this.lineEnd = this.point = vr;
    }, sphere: function sphere() {
      dp.add(Wd);
    } },
      vp = cr(),
      gp = { point: Pr, lineStart: Rr, lineEnd: Lr, polygonStart: function polygonStart() {
      ...
      yp = { sphere: vr, point: Fr, lineStart: jr, lineEnd: Gr, polygonStart: function polygonStart() {
    ...
    var n,
        ...
        var u = o > 0 ? Gd : -Gd,
            f = Jd(o - e);Jd(f - Gd) < Hd ? (t.point(e, r = (r + a) / 2 > 0 ? Vd : -Vd), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), n = 0) : i !== u && f >= Gd && (Jd(e - i) < Hd && (e -= i * Hd), Jd(o - u) < Hd && (o -= u * Hd), r = function (t, n, e, r) {
          var i,
              o,
              a = ap(t - e);return Jd(a) > Hd ? Kd((ap(n) * (o = np(r)) * ap(e) - ap(r) * (i = np(n)) * ap(t)) / (i * o * a)) : (n + r) / 2;
    ...
    var i;if (null == t) i = e * Vd, r.point(-Gd, i), r.point(0, i), r.point(Gd, i), r.point(Gd, 0), r.point(Gd, -i), r.point(0, -i), r.point(-Gd, -i), r.point(-Gd, 0), r.point(-Gd, i);else if (Jd(t[0] - n[0]) > Hd) {
      var o = t[0] < n[0] ? Gd : -Gd;i = e * o / 2, r.point(-o, i), r.point(0, i), r.point(o, i);
    } else r.point(n[0], n[1]);
  }, [-Gd, -Vd]),
      Pp = 1e9,
      zp = -Pp,
      Rp = cr(),
      Lp = { sphere: vr, point: vr, lineStart: function lineStart() {
      Lp.point = bi, Lp.lineEnd = _i;
    }, lineEnd: vr, polygonStart: vr, polygonEnd: vr },
      Dp = [null, null],
      Up = { type: "LineString", coordinates: Dp },
      qp = { Feature: function Feature(t, n) {
      ...
      tv = 0,
      nv = 0,
      ev = { point: qi, lineStart: Oi, lineEnd: Fi, polygonStart: function polygonStart() {
      ev.lineStart = Ii, ev.lineEnd = ji;
    }, polygonEnd: function polygonEnd() {
      ev.point = qi, ev.lineStart = Oi, ev.lineEnd = Fi;
    }, result: function result() {
      var t = nv ? [Kp / nv, tv / nv] : Jp ? [Zp / Jp, Qp / Jp] : Wp ? [Vp / Wp, $p / Wp] : [NaN, NaN];return Vp = $p = Wp = Zp = Qp = Jp = Kp = tv = nv = 0, t;
      ...
      uv,
      fv = cr(),
      cv = { point: vr, lineStart: function lineStart() {
      cv.point = Vi;
    }, lineEnd: function lineEnd() {
      ...
      lv = np(30 * Qd),
      hv = Qi({ point: function point(t, n) {
    ...
    return [-n, 2 * Kd(rp(t)) - Vd];
      ...
      gv = "$",
      yv = { depth: -1 },
      _v = {};ca.prototype = Object.create(Do.prototype);var bv = (1 + Math.sqrt(5)) / 2,
      mv = function t(n) {
    ...
    function e(t) {
      ...
      Nv = function t(n) {
    function e(t) {
      var e = Tv.source(n)(t);return function () {
        return e() / t;
      };
    }return e.source = t, e;
  }(va),
    ...
    return t.getMinutes();
      ...
      Iv = Fv.range,
      jv = Ia(function (t) {
    var n = t.getTimezoneOffset() * qv % 36e5;n < 0 && (n += 36e5), t.setTime(36e5 * Math.floor((+t - n) / 36e5) + n);
  }, function (t, n) {
    t.setTime(+t + 36e5 * n);
  }, function (t, n) {
    return (n - t) / 36e5;
    ...
    var n = new Date(t);return isNaN(n) ? null : n;
      ...
      A_ = Math.PI,
      T_ = A_ / 2,
      N_ = 2 * A_;bf.prototype = { areaStart: function areaStart() {
      this._line = 0;
    ...
    } };var S_ = Ef(mf);Sf.prototype = { areaStart: function areaStart() {
      ...
      var e = Math.sqrt(n / A_);t.moveTo(e, 0), t.arc(0, 0, e, 0, N_);
    } },
      C_ = { draw: function draw(t, n) {
      ...
      P_ = Math.sqrt(1 / 3),
      z_ = 2 * P_,
      R_ = { draw: function draw(t, n) {
      var e = Math.sqrt(n / z_),
          r = e * P_;t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath();
    } },
      ...
      var e = Math.sqrt(.8908130915292852 * n),
          r = D_ * e,
          i = U_ * e;t.moveTo(0, -e), t.lineTo(r, i);for (var o = 1; o < 5; ++o) {
        var a = N_ * o / 5,
            u = Math.cos(a),
      ...
      Y_ = Math.sqrt(3),
      B_ = { draw: function draw(t, n) {
      var e = -Math.sqrt(n / (3 * Y_));t.moveTo(0, 2 * e), t.lineTo(-Y_ * e, -e), t.lineTo(Y_ * e, -e), t.closePath();
    } },
      F_ = Math.sqrt(3) / 2,
      I_ = 1 / Math.sqrt(12),
      j_ = 3 * (I_ / 2 + 1),
      ...
      var e = Math.sqrt(n / j_),
          ...
          a = e * I_ + e,
          u = -o,
          f = a;t.moveTo(r, i), t.lineTo(o, a), t.lineTo(u, f), t.lineTo(-.5 * r - F_ * i, F_ * r + -.5 * i), t.lineTo(-.5 * o - F_ * a, F_ * o + -.5 * a), t.lineTo(-.5 * u - F_ * f, F_ * u + -.5 * f), t.lineTo(-.5 * r + F_ * i, -.5 * i - F_ * r), t.lineTo(-.5 * o + F_ * a, -.5 * a - F_ * o), t.lineTo(-.5 * u + F_ * f, -.5 * f - F_ * u), t.closePath();
    } },
      X_ = [k_, C_, R_, O_, q_, B_, H_];Ff.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
      ...
      switch (this._point) {case 3:
          Bf(this, this._x1, this._y1);case 2:
      ...
      switch (t = +t, n = +n, this._point) {case 0:
          ...
          Bf(this, t, n);}this._x0 = this._x1, this._x1 = t, this._y0 = this._y1, this._y1 = n;
    } }, If.prototype = { areaStart: Yf, areaEnd: Yf, lineStart: function lineStart() {
      ...
      switch (t = +t, n = +n, this._point) {case 0:
          ...
          Bf(this, t, n);}this._x0 = this._x1, this._x1 = t, this._y0 = this._y1, this._y1 = n;
    } }, jf.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
      ...
      switch (t = +t, n = +n, this._point) {case 0:
          ...
          Bf(this, t, n);}this._x0 = this._x1, this._x1 = t, this._y0 = this._y1, this._y1 = n;
    } }, Hf.prototype = { lineStart: function lineStart() {
    ...
    function e(t) {
  ...
  }(.85);Gf.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
      ...
      switch (this._point) {case 2:
          ...
          Xf(this, this._x1, this._y1);}(this._line || 0 !== this._line && 1 === this._point) && this._context.closePath(), this._line = 1 - this._line;
    }, point: function point(t, n) {
      switch (t = +t, n = +n, this._point) {case 0:
          this._point = 1, this._line ? this._context.lineTo(t, n) : this._context.moveTo(t, n);break;case 1:
          this._point = 2, this._x1 = t, this._y1 = n;break;case 2:
          this._point = 3;default:
          Xf(this, t, n);}this._x0 = this._x1, this._x1 = this._x2, this._x2 = t, this._y0 = this._y1, this._y1 = this._y2, this._y2 = n;
    } };var V_ = function t(n) {
    function e(t) {
      return new Gf(t, n);
  ...
  }(0);Vf.prototype = { areaStart: Yf, areaEnd: Yf, lineStart: function lineStart() {
  ...
  }(0);$f.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
    ...
    function e(t) {
  ...
  }(0);Zf.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
      ...
      if (t = +t, n = +n, this._point) {
        var e = this._x2 - t,
          ...
          this._point = 2;break;case 2:
          this._point = 3;default:
          Wf(this, t, n);}this._l01_a = this._l12_a, this._l12_a = this._l23_a, this._l01_2a = this._l12_2a, this._l12_2a = this._l23_2a, this._x0 = this._x1, this._x1 = this._x2, this._x2 = t, this._y0 = this._y1, this._y1 = this._y2, this._y2 = n;
    } };var Z_ = function t(n) {
    function e(t) {
  ...
  }(.5);Qf.prototype = { areaStart: Yf, areaEnd: Yf, lineStart: function lineStart() {
  ...
  }(.5);Jf.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
    ...
    function e(t) {
  ...
  }(.5);Kf.prototype = { areaStart: Yf, areaEnd: Yf, lineStart: function lineStart() {
      this._point = 0;
    }, lineEnd: function lineEnd() {
      ...
      switch (this._point) {case 2:
          ...
          rc(this, this._t0, ec(this, this._t0));}(this._line || 0 !== this._line && 1 === this._point) && this._context.closePath(), this._line = 1 - this._line;
    }, point: function point(t, n) {
      var e = NaN;if (t = +t, n = +n, t !== this._x1 || n !== this._y1) {
        switch (this._point) {case 0:
            this._point = 1, this._line ? this._context.lineTo(t, n) : this._context.moveTo(t, n);break;case 1:
            this._point = 2;break;case 2:
            this._point = 3, rc(this, ec(this, e = nc(this, t, n)), e);break;default:
            rc(this, this._t0, e = nc(this, t, n));}this._x0 = this._x1, this._x1 = t, this._y0 = this._y1, this._y1 = n, this._t0 = e;
      }
    } }, (oc.prototype = Object.create(ic.prototype)).point = function (t, n) {
    ic.prototype.point.call(this, n, t);
  }, ac.prototype = { moveTo: function moveTo(t, n) {
      ...
      var t = this._x,
          n = this._y,
          e = t.length;if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);else for (var r = fc(t), i = fc(n), o = 0, a = 1; a < e; ++o, ++a) {
        this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
      }(this._line || 0 !== this._line && 1 === e) && this._context.closePath(), this._line = 1 - this._line, this._x = this._y = null;
    }, point: function point(t, n) {
      this._x.push(+t), this._y.push(+n);
    } }, cc.prototype = { areaStart: function areaStart() {
      this._line = 0;
    }, areaEnd: function areaEnd() {
      this._line = NaN;
    }, lineStart: function lineStart() {
    ...
    } }, _c.prototype = { constructor: _c, insert: function insert(t, n) {
      var e, r, i;if (t) {
      ...
      } else this._ ? (t = wc(this._), n.P = null, n.N = t, t.P = t.L = n, e = t) : (n.P = n.N = null, this._ = n, e = null);for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C;) {
        e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (mc(this, e), e = (t = e).U), e.C = !1, r.C = !0, xc(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (xc(this, e), e = (t = e).U), e.C = !1, r.C = !0, mc(this, r)), e = t.U;
      }this._.C = !1;
    }, remove: function remove(t) {
      t.N && (t.N.P = t.P), t.P && (t.P.N = t.N), t.N = t.P = null;var n,
          ...
          i = t.U,
          o = t.L,
          a = t.R;if (e = o ? a ? wc(a) : o : a, i ? i.L === t ? i.L = e : i.R = e : this._ = e, o && a ? (r = e.C, e.C = t.C, e.L = o, o.U = e, e !== a ? (i = e.U, e.U = t.U, t = e.R, i.L = t, e.R = a, a.U = e) : (e.U = i, i = e, t = e.R)) : (r = t.C, t = e), t && (t.U = i), !r) if (t && t.C) t.C = !1;else {
        do {
          if (t === this._) break;if (t === i.L) {
            if ((n = i.R).C && (n.C = !1, i.C = !0, mc(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
              n.R && n.R.C || (n.L.C = !1, n.C = !0, xc(this, n), n = i.R), n.C = i.C, i.C = n.R.C = !1, mc(this, i), t = this._;break;
            }
          } else if ((n = i.L).C && (n.C = !1, i.C = !0, xc(this, i), n = i.L), n.L && n.L.C || n.R && n.R.C) {
            n.L && n.L.C || (n.R.C = !1, n.C = !0, mc(this, n), n = i.L), n.C = i.C, i.C = n.L.C = !1, xc(this, i), t = this._;break;
          }n.C = !0, t = i, i = i.U;
        } while (!t.C);t && (t.C = !1);
      }
    } };var K_,
      ...
      ob = [],
      ab = 1e-6,
      ub = 1e-12;Bc.prototype = { constructor: Bc, polygons: function polygons() {
      ...
      var t = [],
        ...
        if (o = (i = e.halfedges).length) for (var i, o, a, u = e.site, f = -1, c = n[i[o - 1]], s = c.left === u ? c.right : c.left; ++f < o;) {
          a = s, s = (c = n[i[f]]).left === u ? c.right : c.left, a && s && r < a.index && r < s.index && Oc(u, a, s) < 0 && t.push([u.data, a.data, s.data]);
        }
      }), t;
    }, links: function links() {
    ...
    } }, Ic.prototype = { constructor: Ic, scale: function scale(t) {
    ...
    } };var fb = new Ic(1, 0, 0);jc.prototype = Ic.prototype, t.version = "5.5.0", t.bisect = Kc, t.bisectRight = Kc, t.bisectLeft = ts, t.ascending = n, t.bisector = e, t.cross = function (t, n, e) {
    var i,
        o,
        a,
        u,
    ...
    function t() {
      var t,
          ...
          g = i.apply(this, u) - Eh,
          y = o.apply(this, u) - Eh;if (a || (a = t = oe()), a.moveTo(d, p), a.arc(0, 0, s, l, h), l === g && h === y || (a.quadraticCurveTo(0, 0, v * Th(g), v * Nh(g)), a.arc(0, 0, v, g, y)), a.quadraticCurveTo(0, 0, d, p), a.closePath(), t) return a = null, t + "" || null;
    }var n = ae,
        e = ue,
        r = fe,
        i = ce,
      ...
      for (var n, e = 0, r = t.length; e < r; ++e) {
        if (n = t[e], n.index = e, isNaN(n.x) || isNaN(n.y)) {
          var i = od * Math.sqrt(e),
              o = e * ad;n.x = i * Math.cos(o), n.y = i * Math.sin(o);
    ...
    var n, e, r, i, o, a, u;if (md = bd = -(yd = _d = 1 / 0), Td = [], br(t, gp), e = Td.length) {
      for (Td.sort(Yr), n = 1, o = [r = Td[0]]; n < e; ++n) {
        Br(r, (i = Td[n])[0]) || Br(r, i[1]) ? (Or(r[0], i[1]) > Or(r[0], r[1]) && (r[1] = i[1]), Or(i[0], r[1]) > Or(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
    ...
    Sd = Ed = kd = Cd = Pd = zd = Rd = Ld = Dd = Ud = qd = 0, br(t, yp);var n = Dd,
        e = Ud,
        r = qd,
        i = n * n + e * e + r * r;return i < Xd && (n = zd, e = Rd, r = Ld, Ed < Hd && (n = kd, e = Cd, r = Pd), (i = n * n + e * e + r * r) < Xd) ? [NaN, NaN] : [tp(e, n) * Zd, dr(r / fp(i)) * Zd];
  }, t.geoCircle = function () {
    function t() {
      var t = r.apply(this, arguments),
          u = i.apply(this, arguments) * Qd,
          f = o.apply(this, arguments) * Qd;return n = [], e = ti(-t[0] * Qd, -t[1] * Qd, 0).invert, oi(a, u, f, 1), t = { type: "Polygon", coordinates: [n] }, n = e = null, t;
    }var n,
        e,
        r = Qr([0, 0]),
        i = Qr(90),
    ...
    var e = t[0] * Qd,
      ...
      var n = ap(t *= p) / v,
          ...
          r = e * s + n * h,
          i = e * l + n * d,
          o = e * u + n * c;return [tp(i, r) * Zd, tp(o, fp(r * r + i * i)) * Zd];
    } : function () {
      return [e * Zd, r * Zd];
    ...
    function t(t) {
      ...
      if (!arguments.length) return f.translate();var e = f.scale(),
          r = +t[0],
          u = +t[1];return i = f.translate(t).clipExtent([[r - .455 * e, u - .238 * e], [r + .455 * e, u + .238 * e]]).stream(l), o = c.translate([r - .307 * e, u + .201 * e]).clipExtent([[r - .425 * e + Hd, u + .12 * e + Hd], [r - .214 * e - Hd, u + .234 * e - Hd]]).stream(l), a = s.translate([r - .205 * e, u + .212 * e]).clipExtent([[r - .214 * e + Hd, u + .166 * e + Hd], [r - .115 * e - Hd, u + .234 * e - Hd]]).stream(l), n();
    ...
    function t(t) {
      var r,
        ...
        if (u = l[i], null != (f = e(t[i], i, t)) && (f += "")) {
          if (!(a = h[gv + f])) throw new Error("missing: " + f);if (a === _v) throw new Error("ambiguous: " + f);a.children ? a.children.push(u) : a.children = [u], u.parent = a;
        } else {
          if (o) throw new Error("multiple roots");o = u;
        }
      }if (!o) throw new Error("no root");if (o.parent = yv, o.eachBefore(function (t) {
    ...
    (t < 0 || t > 1) && (t -= Math.floor(t));var n = Math.abs(t - .5);return f_.h = 360 * t - 100, f_.s = 1.5 - 1.5 * n, f_.l = .8 - .9 * n, f_ + "";
  }, t.interpolateWarm = a_, t.interpolateCool = u_, t.interpolateSinebow = function (t) {
    var n;return t = (.5 - t) * Math.PI, c_.r = 255 * (n = Math.sin(t)) * n, c_.g = 255 * (n = Math.sin(t + s_)) * n, c_.b = 255 * (n = Math.sin(t + l_)) * n, c_ + "";
    ...
    function t() {
      var t,
        ...
        if (p > N_ - M_) f.moveTo(l * __(h), l * x_(h)), f.arc(0, 0, l, h, d, !v), s > M_ && (f.moveTo(s * __(d), s * x_(d)), f.arc(0, 0, s, d, h, v));else {
          var g,
              y,
              _ = h,
              b = d,
              ...
              E = N;if (T > M_) {
            var k = hf(T / s * x_(A)),
                C = hf(T / l * x_(A));(w -= 2 * k) > M_ ? (k *= v ? 1 : -1, m += k, x -= k) : (w = 0, m = x = (h + d) / 2), (M -= 2 * C) > M_ ? (C *= v ? 1 : -1, _ += C, b -= C) : (M = 0, _ = b = (h + d) / 2);
          }var P = l * __(_),
              z = l * x_(_),
              R = s * __(x),
              L = s * x_(x);if (N > M_) {
            var D = l * __(b),
              ...
              var Y = w > M_ ? function (t, n, e, r, i, o, a, u) {
                ...
                return t > 1 ? 0 : t < -1 ? A_ : Math.acos(t);
                  ...
                  X = w_(Y[0] * Y[0] + Y[1] * Y[1]);S = m_(N, (s - X) / (H - 1)), E = m_(N, (l - X) / (H + 1));
            }
      ...
      var t = (+n.apply(this, arguments) + +e.apply(this, arguments)) / 2,
          r = (+o.apply(this, arguments) + +a.apply(this, arguments)) / 2 - A_ / 2;return [__(r) * t, x_(r) * t];
    ...
    function t(t) {
      var u,
        ...
        i = lf(0),
        o = lf(N_),
        a = lf(0);return t.value = function (e) {
      return arguments.length ? (n = "function" == typeof e ? e : lf(+e), t) : n;
    ...
    var t = Df(Of);return t.angle = t.x, delete t.x, t.radius = t.y, delete t.y, t;
  }, t.symbol = function () {
    function t() {
    ...
    var e,
      ...
      n = null == n ? null : n + "";for (r in i) {
        if ((e = i[r]).state > Ll && e.name === n) return new On([[t]], hh, n, +r);
      }
    }return null;
  }, t.interrupt = Dn, t.voronoi = function () {
    function t(t) {
      return new Bc(t.map(function (r, i) {
        var o = [Math.round(n(r, i, t) / ab) * ab, Math.round(e(r, i, t) / ab) * ab];return o.index = i, o.data = r, o;
      }), r);
    }var n = gc,
        e = yc,
    ...
    function n(t) {
      ...
      t.on("start.zoom", function () {
        ...
        var t = arguments,
          ...
          if (1 === t) t = s;else {
            var n = l(t),
                e = f / n[2];t = new Ic(e, u[0] - n[0] * e, u[1] - n[1] * e);
          }r.zoom(null, t);
        };
      });
    }function a(t, n) {
      ...
      if (!v && g.apply(this, arguments)) {
        var n = a(this, arguments),
          ...
          e.on("mousemove.zoom mouseup.zoom", null), bt(t.event.view, n.moved), Xc(), n.end();
            ...
            i = pt(this),
            o = t.event.clientX,
            u = t.event.clientY;_t(t.event.view), Hc(), n.mouse = [i, this.__zoom.invert(i)], Dn(this), n.start();
      }
    }function s() {
      if (g.apply(this, arguments)) {
        var i = this.__zoom,
            ...
            c = _(r(e(i, f), a, u), y.apply(this, arguments), w);Xc(), M > 0 ? ct(this).transition().duration(M).call(o, c, a) : ct(this).call(n.transform, c);
      }
    }function l() {
      if (g.apply(this, arguments)) {
        var n,
      ...
      var n,
          ...
          s = c.length;for (Xc(), p && (p = clearTimeout(p)), n = 0; n < s; ++n) {
      ...
      var n,
          ...
          o = i.length;for (Hc(), v && clearTimeout(v), v = setTimeout(function () {
        v = null;
      }, E), n = 0; n < o; ++n) {
      ...
      var e = t.selection ? t.selection() : t;e.property("__zoom", $c), t !== e ? o(t, n) : e.interrupt().each(function () {
      ...
      n.transform(t, function () {
        var t = y.apply(this, arguments),
            n = this.__zoom,
            o = i(t);return _(fb.translate(o[0], o[1]).scale(n.k).translate("function" == typeof e ? -e.apply(this, arguments) : -e, "function" == typeof r ? -r.apply(this, arguments) : -r), t, w);
      });
